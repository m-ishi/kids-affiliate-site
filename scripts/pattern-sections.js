...
const patternSections = {
  ...
  'brand-trust': {
    name: 'ブランド信頼性調査（どこの国・怪しい・安全？）',
    sections: [
      { title: '「[商品名]って怪しくない？」と検索したあなたへ、調査結果の結論', chars: '300-400', desc: '結論を最初に言い切る: 会社の実在性・安全性の根拠・買ってよいかの判断。AI検索と流し読み対策で最重要' },
      { title: '[商品名]はどこの国のブランド？会社概要を調べてみた', chars: '600-800', desc: '本社所在地・設立年・日本法人や正規代理店の有無・販売実績。公式情報と登記ベースの事実のみ。憶測は書かない' },
      { title: '「怪しい」と言われる理由を分解する', chars: '500-700', desc: '知名度不足・価格の安さ・海外ブランドへの不安など、不安の正体を客観的に整理。根拠のない断定は禁止' },
      { title: '安全性の根拠をチェック: 認証・規格・検査の実態', chars: '700-900', desc: 'STマーク・PSC・PSE・食品衛生法検査など該当規格の取得状況を事実ベースで。取得が確認できないものは「確認できない」と正直に書く' },
      { title: '実際の口コミ・評判を徹底収集した結果', chars: '700-900', desc: '良い口コミと悪い口コミを両方。特に安全面・耐久面の指摘を重点的に' },
      { title: 'トラブル事例と対処法: 保証・返品・サポート体制', chars: '500-600', desc: '初期不良時の対応、日本語サポートの有無、Amazonの返品保護など実務情報' },
      { title: '大手・国産ブランドと比べてどう？価格差の理由', chars: '500-700', desc: '同カテゴリの定番品と機能・価格・保証を比較表で。安さの理由を構造的に説明' },
      { title: 'おすすめできる人・やめた方がいい人', chars: '400-500', desc: '調査結果に基づく向き不向きの判定。安全最優先なら国産という選択肢も正直に提示' },
      { title: '調査まとめ: 買う前にチェックすべき3点', chars: '300-400', desc: '購入判断のチェックリストで締める' },
    ],
  },
